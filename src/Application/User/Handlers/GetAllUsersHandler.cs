...
namespace Application.User.Handlers
{
    public class GetAllUsersHandler : IRequestHandler<GetAllUsersQuery, PagedList<BasicUserModel>>
    {
        ...
        {
            return await _userService.GetAllUsers(request.SearchTerm, request.SortColumn, request.SortOrder, Convert.ToInt32(request.Page), Convert.ToInt32(request.PageSize));
        }
    }
}
